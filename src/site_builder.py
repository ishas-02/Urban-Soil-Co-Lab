...
# VLM-based sketch extraction (Chunk 1 + 2)
from vlm_extractor import render_vlm_section
from dotenv import load_dotenv
load_dotenv()   # reads .env from the project root, sets os.environ
...
# ═══════════════════════════════════════════════
#  STEP 5½ — AUTO-EXTRACT FROM SKETCH (optional)
# ═══════════════════════════════════════════════
# VLM-powered sketch upload. Drops between Grid Layout and Define
# Grid Rows so accepting an extraction pre-fills sections ⑥ and ⑦.
# All state is yard-scoped — Front and Back never collide.
render_vlm_section(yard_key=yard_key, yard_choice=yard_choice)
